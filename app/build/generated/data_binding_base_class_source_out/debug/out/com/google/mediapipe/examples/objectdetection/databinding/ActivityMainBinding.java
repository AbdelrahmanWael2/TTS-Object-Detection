...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull CoordinatorLayout rootView, @NonNull Button button,
      ...
      @NonNull RelativeLayout relativeLayout, @NonNull Toolbar toolbar, @NonNull View view) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((CoordinatorLayout) rootView, button, fragmentContainer,
          navigation, relativeLayout, toolbar, view);
    }
